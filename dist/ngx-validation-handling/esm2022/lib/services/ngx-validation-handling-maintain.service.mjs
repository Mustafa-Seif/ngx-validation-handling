...
export class NgxValidationHandlingMaintainService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.3.11", ngImport: i0, type: NgxValidationHandlingMaintainService, deps: [{ token: i1.NgxValidationHandlingService }], target: i0.ɵɵFactoryTarget.Injectable }); }
